...
When having a "start" and an "end" time, a powerful way to analyze the data is to "explode" the intervals into individual rows.
...
The `explode` method unnests the list-column, duplicating other column values for each element in the sequence.
